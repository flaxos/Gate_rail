...
RESOURCE_DEFINITIONS: dict[str, ResourceDefinition] = {
    ...
    "ceramics": ResourceDefinition(
        ...
        description="Heat-resistant processed silicates for plants and gate hardware.",
        tags=("heat", "construction"),
    ),
    ...
    "semiconductors": ResourceDefinition(
        ...
        category=ResourceCategory.MANUFACTURED_GOOD,
        cargo_type=CargoType.ELECTRONICS,
        description="Wafer and chip output for advanced plants and gates.",
        rarity="uncommon",
        tags=("wafer", "advanced"),
    ),
    "reactor_parts": ResourceDefinition(
        ...
        description="Specialized assemblies for plant upgrades and gate power support.",
        rarity="uncommon",
        tags=("power", "advanced"),
    ),
    "gate_components": ResourceDefinition(
        ...
        description="Precision assemblies used to build and stabilize wormhole gates.",
        rarity="rare",
        tags=("gate", "advanced"),
    ),
    "gate_reactive_isotope": ResourceDefinition(
        id="gate_reactive_isotope",
        name="Gate-reactive Isotope",
        category=ResourceCategory.EXOTIC,
        description="Undiscovered exotic isotope for late-game gate overcharging.",
        rarity="exotic",
        discovered_by_default=False,
        tags=("gate", "exotic", "research"),
    ),
    "null_lattice_crystal": ResourceDefinition(
        id="null_lattice_crystal",
        name="Null-lattice Crystal",
        category=ResourceCategory.EXOTIC,
        description="Theoretical crystalline resource that may exist beyond surveyed space.",
        rarity="exotic",
        discovered_by_default=False,
        tags=("space", "exotic", "research"),
    ),
}
